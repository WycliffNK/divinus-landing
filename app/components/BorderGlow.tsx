...
export type BorderGlowProps = Omit<React.HTMLAttributes<HTMLDivElement>, 'children'> & {
  children: ReactNode;
  className?: string;
  ...
  glowColor?: string;
  /** Background colour of the inner card surface. */
  backgroundColor?: string;
  /** Card corner radius in px. */
  borderRadius?: number;
  /** Outer glow extension beyond the card in px. */
  glowRadius?: number;
  ...
  animated?: boolean;
  /** Up to 3 hex colours used to seed the mesh gradient border. */
  colors?: string[];
  /** Opacity multiplier for the colored fill layer (0–1). */
  fillOpacity?: number;
};
