export default function Logo({ className = 'h-6 w-auto text-neutral-50' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 115.95 118.36" fill="currentColor" aria-label="Divinus" role="img" xmlns="http://www.w3.org/2000/svg">
